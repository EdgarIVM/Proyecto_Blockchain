...
class Blockchain:
    ...
    def proof_of_work(self, previous_proof):
        ...
        while check_proof is False:
            hash_operation = hashlib.sha256(str(new_proof**3 - previous_proof*2+new_proof).encode()).hexdigest()
    ...
    def is_chain_valid(self, chain):
        ...
        while block_index < len(chain):
            ...
            proof = block['proof']
            hash_operation = hashlib.sha256(str(proof**3 + previous_proof*2+proof).encode()).hexdigest()
            if hash_operation[:5] != '00000':
                return False
...
def mine_block():
    ...
    blockchain.add_transaction(sender = node_address, receiver = 'Edgar', amount = 1)
...
def connect_node():
    ...
    response = {'message':'Todos los ndoos estan ahora conectados. El AmloPesos Blockchain contiene los siguientes nodos:',
